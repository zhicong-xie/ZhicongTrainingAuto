...
public class LoginSteps {
    ...
    @When("^the user click (Setting|International area code|Forget password|Confirm|Create profile) button in the Storellet login screen$")
    ...
    @When("^the user select \"([^\"]*)\" International area code in the Storellet login screen area code partial modal$")
